...
namespace ML.AdvCan.CanDriver
{
    ...
    {		
        ...
        [DllImport("kernel32.dll", SetLastError = true)]
        public static extern bool WriteFile(IntPtr hDevice, CanDriver.canmsg_t[] msgWrite, uint nNumberOfFramesToWrite, out uint lpNumberOfFramesWritten, IntPtr lpOverlapped);
